    ...
    return (
        <section className="coverage-tech" id="cobertura">
            <div className="coverage-tech__container">
                ...
                <div className="coverage-tech__info">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <span className="tech-section-label">// SEDE</span>
                        <h2 className="tech-section-title">
                            Nuestra Sede <span>Principal</span>
                        </h2>
                    ...
                    >
                        <div className="tech-info-card">
                            ...
                            <span className="tech-card-label">UBICACIÓN ESTRATÉGICA</span>
                            <div className="tech-card-value">
                                Edificio Telenet, Local 2-97<br />
                                Sector Independencia I<br />
                                Barinas 5201, VE
                            </div>
                        </div>
                        ...
                        <div className="tech-info-card">
                            <div className="tech-card-glow"></div>
                            <span className="tech-card-label">OPERACIONES</span>
                            <div className="tech-card-value">
                                <div className="tech-time-row"><span>LUN-VIE</span><span>8:00 AM - 5:00 PM</span></div>
                                <div className="tech-time-row"><span>SÁBADO</span><span>8:00 AM - 12:00 PM</span></div>
                                <div className="tech-time-row tech-highlight"><span>MONITOREO</span><span>24/7 ACTIVO</span></div>
                            </div>
                        </div>
                    </motion.div>
                ...
                {/* Right Side: Dot-Matrix Map */}
                <div className="coverage-tech__map-wrapper">
                    <div className="tech-map-container">

                        {/* SVG Venezuela Map abstract polygon */}
                        <svg className="venezuela-svg" viewBox="0 0 1024 1024" preserveAspectRatio="xMidYMid meet">
                            <defs>
                                <pattern id="dot-matrix" x="0" y="0" width="30" height="30" patternUnits="userSpaceOnUse" patternTransform="scale(1, -1)">
                                    <circle cx="15" cy="15" r="9" fill="rgba(58, 180, 230, 0.4)" />
                                </pattern>
                                <filter id="neon-glow">
